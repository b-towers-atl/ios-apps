...
//  MotionSickness
//
//  Created by Bobby Towers on 2/16/15.
//  Copyright (c) 2015 Bobby Towers. All rights reserved.
//

// single view controller
// core motion and ui kit dynamics
// single ball in center of the screen, zero gravity
// based on yaw, pitch, and roll (choose two)
...
//    let value = d * 100
//    let roundedValue = round(value) / 100
//    return roundedValue
