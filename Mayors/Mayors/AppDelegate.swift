...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, openURL url: NSURL, sourceApplication: String?, annotation: AnyObject?) -> Bool {
        ...
        // prints in console: Optional("mayors://mayors.com#access_token=Q124AFASFCUR0ASFCMZ1")
            ...
            if urlParts.count > 1 {
                ...
                if tokenParts.count > 1 {
                    ...
                    if tokenParts[0] == "access_token" {
                        ...
                        // This is the trigger and we set its name to FSConnectWithToken, this is triggering it
                        // this is the guy on the track who fires the gun at the start of the race
